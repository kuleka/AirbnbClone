    ...
    return (
        <>
            <div className='flex gap-2'>
                ...
                <button className='bg-gray-200 px-4 rounded-2xl' onClick={addPhotoByLink}>Add&nbsp;photo
                </button>
            </div>
            ...
            <div className='mt-2 grid grid-cols-3 gap-2 md:grid-cols-4 lg:grid-cols-6'>
                {addedPhotos.length > 0 && addedPhotos.map(link => (
                    <div key={link} className='h-32 flex relative'>
                        <img className='rounded-2xl w-full object-cover'
                             src={`http://localhost:3000/uploads/${link}`} alt=""/>
                ...
                <label
                    className='h-32 cursor-pointer justify-center gap-1 border bg-transparent rounded-2xl p-8 text-gray-600 flex flex-col items-center'>
